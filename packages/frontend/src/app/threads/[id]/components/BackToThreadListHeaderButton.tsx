...
export function BackToThreadListHeaderButton({ className }: Props) {
	...
	return (
		<Button
			...
			className={cn(
				"inline-flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-semibold text-slate-600 transition-colors duration-200 [@media(hover:hover)]:hover:!bg-gray-600/30 md:text-sm",
				className,
			)}
		>
