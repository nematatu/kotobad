...
>(({ className, ...props }, ref) => (
	...
	>
		<SwitchPrimitives.Thumb
			className={cn(
				"pointer-events-none block h-4 w-4 transform-gpu rounded-full bg-background shadow-lg ring-0 transition-transform duration-200 ease-out will-change-transform group-data-[state=checked]:translate-x-4 group-data-[state=unchecked]:translate-x-0",
			)}
		/>
	</SwitchPrimitives.Root>
));
