				...
				<CreateThreadDialog
					...
					trigger={
						<button
							...
							className="route-transition-floating-action fixed bottom-20 right-4 z-[70] inline-flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-blue-500/90 text-white shadow-lg [@media(min-width:496px)]:hidden"
						>
							<Plus size={24} />
						</button>
					}
