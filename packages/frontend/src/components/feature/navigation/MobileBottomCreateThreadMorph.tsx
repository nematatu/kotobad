...
const DRAWER_HEIGHT_CLS =
	"h-[min(840px,calc(100svh-1.5rem-env(safe-area-inset-bottom)))] min-h-[min(840px,calc(100svh-1.5rem-env(safe-area-inset-bottom)))] max-h-[min(840px,calc(100svh-1.5rem-env(safe-area-inset-bottom)))]";
