DROP TABLE `japanTournaments`;--> statement-breakpoint
...
INSERT INTO `__new_achievements`("id", "player_id", "year", "result") SELECT "id", "player_id", "year", "result" FROM `achievements`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_thread_label`("thread_id", "label_id") SELECT "thread_id", "label_id" FROM `thread_label`;--> statement-breakpoint
